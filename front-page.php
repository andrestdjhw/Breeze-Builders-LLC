...
<section class="section">
	<div class="wrap">
		...
		<h2 style="max-width:24ch;">One company. One responsibility. Less risk on you.</h2>
	...
	<div class="wrap wrap--sm">
		...
		<div class="faq" style="margin-top:1.5rem;border-top:1px solid var(--line);">
			...
			<details style="border-bottom:1px solid var(--line);padding:1rem 0;">
				...
				<p style="margin:.7rem 0 0;">We self-perform all three and coordinate them as your general contractor. That means one estimate, one schedule, and one company accountable for the whole job — not four subcontractors you have to manage.</p>
			</details>
			<details style="border-bottom:1px solid var(--line);padding:1rem 0;">
